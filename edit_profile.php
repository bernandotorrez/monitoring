...
if(isset($_POST['btn-edit']))
{
	...
	$euname = trim($_POST['euname']);
	$id = $_SESSION['userSession'];
$level = trim($_POST['level']);

	
	if($edit_user->edit($euname, $id, $level))
	{
	header("Location: profile.php?id=".$_SESSION['userSession']."&aksi=editsukses");
					
		}
		else
		{
			header("Location: profile.php?id=".$_SESSION['userSession']."&aksi=editgagal");
		}	
}
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>User Profile Page - Sistem Monitoring Proyek PT. Malmass Mitra Teknik</title>
												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														...
														?>
															...
															if($_GET['id'] > 0) {
																?>
															<span class="white"><?php echo $rows['username']; ?></span>
															<?php } else {?>
...
<?php 
		if($_GET['aksi']=='editsukses')
		{
            ...
            <div class='alert alert-success'>
				...
				<strong>Hore!</strong> Edit Biodata Kamu Berhasil. 
			</div></center>
            <?php
		}
		?>
		...
		if($_GET['aksi']=='editgagal')
		{
            ...
            <div class='alert alert-info'>
				...
				<strong>Sorry!</strong> Edit Biodata Kamu Gagal. 
			</div></center>
            <?php
		}
		?>
		...
		if($_GET['mode']=='edit')
		{
			?> 	<input type="text" class="form-control" placeholder="Nama Kamu" name="euname" value="<?php echo $row['username']; ?>"/>
			<?php } else { ?>
													<span class="editable" id="" name="euname"><?php echo $row['username']; ?></span>
													<?php } ?>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="">Netherlands</span>
														<span class="editable" id="">Amsterdam</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<?php 
		if($row['level'] == 'Admin' && $_GET['mode']=='edit')
		{
			?> 	<input type="text" class="form-control" placeholder="Nama Kamu" name="level" value="<?php echo $row['level']; ?>"/>
			<?php } else { ?>
													<span class="editable" id=""><?php echo $row['level']; ?></span>
													<?php } ?>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="">2010/06/20</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="">3 hours ago</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="">Editable as WYSIWYG</span>
													</div>
												</div>
												<div class="profile-info-row">
		...
		if($_GET['mode']=='edit')
		{ 
			?> <button type="submit" class="btn btn-sm btn-primary" name="btn-edit">
															<i class="ace-icon fa fa-key"></i>
															<span class="bigger-110">Simpan</span>
														</button>
			<?php } else { ?>
													
													<a href="profile.php?id=<?php echo $row['id'];?>&mode=edit" type="submit" class="btn btn-sm btn-primary"><span class="bigger-110"><i class="ace-icon fa fa-key"></i> Edit</span></a>
													<?php } ?>
