...
if(isset($_POST['btn-edit']))
{
	...
	if($edit_user->edit($euname, $id))
	{
	header("Location: profile.php?aksi=editsukses");
					
		}
		else
		{
			header("Location: profile.php?aksi=editgagal");
		}	
}
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="id-message-form" class="hide form-horizontal message-form col-xs-12" action="" method="post">
									<div>
